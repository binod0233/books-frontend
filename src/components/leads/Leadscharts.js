    ...
    <div style={{ background: "" }} className="">
      ...
      <Row  >
        ...
        <div className="pt-3" style={{ fontWeight: "700", fontSize: "1.2rem" , }}>Leads Stats</div>
                  ...
                  <div style={{ fontWeight: "700", fontSize: "1.2rem" }} className='d-flex justify-content-center align-items-center '>Total Leads: 25</div>
        </div>
        </Col>
        
        <Col  md={4} className="d-flex flex-column   " style={{ height: ""}}>
      
          <div className=" pt-4 pb-2" style={{ background: "white", height: "inherit", width: "100%" }}>
            ...
            <Stack className="px-3 " style={{}}>
              ...
              <div className="pt-5" style={{ textAlign: "center", fontSize: '20px', fontWeight: '700' }}>Lead Source</div>
            </Stack>
          </div>
