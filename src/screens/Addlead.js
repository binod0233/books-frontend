...
const Addlead = () => {
  ...
  return (
    <div
      ...
      style={{ background: "#F1F1FA", height: "90vh" }}
    >
      <div
        ...
        <div className="">
          <div className="ps-4  " style={{ fontFamily: "Arial" }}>
            ...
            <p style={{ color: "#7B7B7B", fontSize: "12px" }}>
              Add your New Lead here by filling up the form
            </p>
          </div>
          <div className="formContainer mx-5 my-3 bg-white p-4">
            ...
            >
              <div
                style={{
                  borderBottom:
                    activeTab === "1" ? "3px solid #DD2A7B" : "none",
                }}
                onClick={() => {
                  setActiveTab("1");
                }}
              ...
              <div
                style={{
                  borderBottom:
                    activeTab === "2" ? "3px solid #DD2A7B" : "none",
                }}
                onClick={() => {
                  setActiveTab("2");
                }}
              ...
              <div
                style={{
                  borderBottom:
                    activeTab === "3" ? "3px solid #DD2A7B" : "none",
                }}
                onClick={() => {
                  setActiveTab("3");
                }}
                  ...
                  <Row className="mx-5 pt-4">
                    ...
                    <Col className="ps-3">
                      <Form.Group controlId="email">
                        ...
                        <Form.Control
                          type="email"
                          placeholder="Nabin Chaudhary@gmail.com"
                          value={email}
                        ...
                        <Col className="" md={1}>
                          <Form.Group controlId="email">
                            <Button
                              ...
                              style={{
                                border:
                                  activeGender === "1" && "1px solid #DD2A7B",
                                color: activeGender === "1" && "#DD2A7B",
                                background: activeGender === "1" && "black",
                              }}
                              onClick={(e) => {
                                setGender("male");
                                setActiveGender("1");
                        ...
                        <Col className=" ms-4" md={2}>
                          ...
                          >
                            <Button
                              ...
                              style={{
                                border:
                                  activeGender === "2" && "1px solid #DD2A7B",
                                color: activeGender === "2" && "#DD2A7B",
                                background: activeGender === "2" && "black",
                              }}
                              onClick={(e) => {
                                setGender("female");
                                setActiveGender("2");
          ...
          */}
                        ...
                        <Col md={6}>
                          <Form.Group controlId="work">
                            ...
                            <Select
                              options={options}
                              isMulti
                              onChange={(e) => setCommunicationChannel(e)}
                            />
                          </Form.Group>
                        </Col>
                      </Row>
                    ...
                    <Col className="ps-3">
                      <Form.Group controlId="clentbackground">
                        ...
                        <Form.Control
                          type="text"
                          placeholder="Done mechanicalengineering and now wants to..."
                          value={leadBackground}
                          onChange={(e) => setLeadBackground(e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                  </Row>
                    ...
                    <Col className="ps-3">
                      <Form.Group controlId="serviceplan">
                        ...
                        >
                          <option
                            value="none"
                            onClick={(e) => setServicePlan(e.target.value)}
                          >
                            Choose one
                          </option>
                      ...
                      <Col>
                        <Form.Group controlId="work">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setLastFollowUpDate(e.target.value)
                            }
                          />
                        </Form.Group>
                      </Col>
                    ...
                    <Col>
                      <Form.Group controlId="clientmanager">
                        ...
                        >
                          <option
                            value=""
                            onClick={(e) => setClientManager(e.target.value)}
                          >
                            Choose One
                          </option>
