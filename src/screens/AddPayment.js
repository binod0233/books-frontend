      ...
      <div className=" py-5 d-flex flex-column" style={{ width: "100%" }}>
        <div style={{ background: "#F1F1FA" }}>
          ...
          <div className="formContainer mx-5 my-3 bg-white p-4">
            <h6 style={{ fontWeight: "700" }}>Add a Payment</h6>
            ...
            <Form onSubmit={addAPayment}>
              ...
              {/*
                ...
                <div className="d-grid gap-2 d-md-block d-flex justify-content-center align-items-center mt-5">
                <div>
                <Button className="btn btn-primary" type="button">Add Payment</Button>
                </div>{' '}
                <Button className="btn btn-primary"  onClick={() => navigate("/leads")} type="Button">Cancel</Button>
               </div>
             ...
             style={{ width: "100%" }}
           >
             <Button type="submit" className='me-2'>Add Payment</Button>{" "}
